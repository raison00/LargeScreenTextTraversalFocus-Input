...
### The Old Way: You had to manually "hoist" the string and update it. If you did any heavy processing in onValueChange, you could cause typing lag.  This sample code will be updated in 2026 to support the current API with full support of SDK 23.
